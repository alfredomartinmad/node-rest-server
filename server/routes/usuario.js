...
app.post('/usuario', [verificaToken, verificaUsuario], (req, res) => {
...
app.put('/usuario/:id', [verificaToken, verificaUsuario], (req, res) => {
...
app.delete('/usuario/:id', [verificaToken, verificaUsuario], (req, res) => {
